...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".mobcode/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".mobcode/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".mobcode/glossary/zh-tw.md")
  })

...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "mobcode")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "mobcode")

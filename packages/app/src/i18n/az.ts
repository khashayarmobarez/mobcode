export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobCode yüklənə bilmədi",
  "desktop.recovery.terminated": "MobCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "MobCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "MobCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "MobCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MobCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və MobCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və MobCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və MobCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər mobcode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu MobCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MobCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də MobCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "MobCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də MobCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də MobCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "MobCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "MobCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "MobCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "MobCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "MobCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "MobCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra MobCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "MobCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı MobCode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (mobcode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: MobCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "MobCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində MobCode serverini işlət.",
  ...
  "settings.general.row.language.description": "MobCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "MobCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "MobCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "MobCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "MobCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "MobCode-un ən son versiyasından istifadə edirsiniz.",

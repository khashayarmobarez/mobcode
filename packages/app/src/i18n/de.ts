...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von MobCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MobCode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in MobCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MobCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In mobcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den MobCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "MobCode",
  ...
  "wsl.onboarding.checkingOpencode": "MobCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "MobCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "MobCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "MobCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie MobCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MobCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "MobCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "MobCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie MobCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "MobCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor MobCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "MobCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann MobCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von MobCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MobCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (mobcode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MobCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "MobCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "MobCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "MobCode Desktop",
  ...
  "settings.desktop.wsl.description": "MobCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MobCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie MobCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MobCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MobCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MobCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "MobCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von MobCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "MobCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das MobCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "MobCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "MobCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das MobCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "MobCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":

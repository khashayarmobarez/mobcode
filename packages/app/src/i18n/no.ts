...
export const dict = {
  ...
  "desktop.menu.documentation": "MobCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "MobCode-meny",
  ...
  "desktop.recovery.loadFailed": "MobCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "MobCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "MobCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av MobCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av MobCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MobCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MobCode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i mobcode.json",
  ...
  "dialog.server.description": "Bytt hvilken MobCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MobCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MobCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (mobcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MobCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MobCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MobCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MobCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MobCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om MobCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i MobCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MobCode starter",
  ...
  "settings.updates.toast.latest.title": "MobCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MobCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker MobCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer MobCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater MobCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer MobCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før MobCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "MobCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter MobCode på nytt.",
  ...
  "help.tabs.introduction": "MobCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":

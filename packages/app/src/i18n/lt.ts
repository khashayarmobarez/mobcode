...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "MobCode įkelti nepavyko",
  "MobCode langas netikėtai užsidarė",
  "MobCode neatsako",
  ...
  "MobCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "MobCode neįdiegtas distributyve {{distro}}",
  "MobCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami MobCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius MobCode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti mobcode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio MobCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama MobCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas MobCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite MobCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite MobCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad MobCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "MobCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują MobCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą MobCode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (mobcode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad MobCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "MobCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "MobCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite MobCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite MobCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip MobCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar MobCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite MobCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas MobCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią MobCode versiją.",

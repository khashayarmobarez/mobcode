export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobCode kunde inte läsas in",
  "desktop.recovery.terminated": "MobCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "MobCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av MobCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av MobCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i MobCode.",
  ...
  "dialog.server.description": "Växla vilken MobCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar MobCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar MobCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera MobCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera MobCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan MobCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "MobCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan MobCode igen.",
  ...
  "help.tabs.introduction": "MobCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av MobCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till MobCode-teamet",
  ...
  "sidebar.gettingStarted.line1": "MobCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör MobCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för MobCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur MobCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om MobCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa MobCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när MobCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av MobCode.",

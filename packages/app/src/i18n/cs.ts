export const dict = {
  ...
  "desktop.menu.documentation": "MobCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka MobCode",
  ...
  "desktop.recovery.loadFailed": "MobCode se nepodařilo načíst",
  "desktop.recovery.terminated": "MobCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "MobCode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "MobCode instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezplatné modely poskytované MobCode",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v MobCode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v mobcode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému MobCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola MobCode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace MobCode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace MobCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte MobCode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než MobCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "MobCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete MobCode.",
  ...
  "help.tabs.introduction": "MobCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze MobCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu MobCode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (mobcode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: MobCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server MobCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro MobCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled MobCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude MobCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma MobCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění MobCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi MobCode.",

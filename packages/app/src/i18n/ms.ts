export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi MobCode",
  ...
  "desktop.recovery.loadFailed": "MobCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap MobCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "MobCode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan MobCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini MobCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh MobCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MobCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam mobcode.json",
  ...
  "dialog.server.description": "Tukar pelayan MobCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak MobCode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini MobCode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini MobCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang MobCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MobCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MobCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu MobCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan MobCode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (mobcode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, MobCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan MobCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk MobCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa MobCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada MobCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema MobCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila MobCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini MobCode.",

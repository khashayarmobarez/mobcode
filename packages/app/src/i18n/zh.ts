...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobCode 加载失败",
  "desktop.recovery.terminated": "MobCode 窗口意外终止",
  "desktop.recovery.unresponsive": "MobCode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "MobCode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 MobCode",
  "desktop.wsl.error.updateVersion":
    "MobCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MobCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 MobCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "MobCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 MobCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 MobCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 MobCode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 MobCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 MobCode 已就绪。",
  "wsl.onboarding.opencodeReady": "MobCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 MobCode。",
  "wsl.onboarding.installOpencode": "安装 MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 MobCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "MobCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "MobCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 MobCode。",
  ...
  "help.tabs.introduction": "MobCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 MobCode 团队",
  ...
  "sidebar.gettingStarted.line1": "MobCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 MobCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 MobCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 MobCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 MobCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 MobCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 MobCode 启动时自动检查更新",

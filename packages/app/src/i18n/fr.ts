export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'MobCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'MobCode",
  "desktop.recovery.terminated": "La fenêtre MobCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "MobCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'MobCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'MobCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par MobCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MobCode.",
  ...
  "dialog.server.description": "Changez le serveur MobCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'MobCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'MobCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour MobCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez MobCode dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'MobCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "MobCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'MobCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MobCode",
  ...
  "sidebar.gettingStarted.line1":
    "MobCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MobCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MobCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MobCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MobCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MobCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MobCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MobCode.",

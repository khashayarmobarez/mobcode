export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja MobCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać MobCode",
  "desktop.recovery.terminated": "Okno MobCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "MobCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować MobCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja MobCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MobCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MobCode.",
  ...
  "dialog.server.description": "Przełącz serwer MobCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie MobCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie MobCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj MobCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj MobCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim MobCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "MobCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja MobCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MobCode",
  ...
  "sidebar.gettingStarted.line1": "MobCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer MobCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MobCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd MobCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MobCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MobCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MobCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MobCode.",

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za MobCode",
  ...
  "desktop.menu.ariaLabel": "MobCode meni",
  ...
  "desktop.recovery.loadFailed": "MobCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor MobCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "MobCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija MobCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje MobCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MobCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MobCode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MobCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MobCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u mobcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se MobCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera MobCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MobCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj MobCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj MobCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi MobCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "MobCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MobCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MobCode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (mobcode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MobCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MobCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MobCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MobCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako MobCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MobCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MobCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MobCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MobCode-a.",

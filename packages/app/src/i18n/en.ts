...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MobCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MobCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "MobCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MobCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in mobcode.json",
  ...
  "dialog.server.description": "Switch which MobCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MobCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MobCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MobCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MobCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MobCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MobCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of MobCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MobCode team",
  ...
  "error.chain.checkConfig": "Check your config (mobcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MobCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MobCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the MobCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MobCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how MobCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MobCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MobCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MobCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MobCode.",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل MobCode",
  "desktop.recovery.terminated": "توقفت نافذة MobCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "MobCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت MobCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث MobCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من MobCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك MobCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في MobCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في mobcode.json",
  ...
  "dialog.server.description": "تبديل خادم MobCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من MobCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث MobCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث MobCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت MobCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن MobCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على MobCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح MobCode.",
  ...
  "help.tabs.introduction": "أصبح MobCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من MobCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق MobCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (mobcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن MobCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن MobCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم MobCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ MobCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور MobCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان MobCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة MobCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل MobCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من MobCode.",

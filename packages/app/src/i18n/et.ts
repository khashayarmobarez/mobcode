export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "MobCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "MobCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "MobCode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub MobCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid MobCode'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises MobCode.",
  ...
  "dialog.server.description": "Lülitage, millise MobCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "MobCode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "MobCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MobCode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "MobCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda MobCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige MobCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui MobCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "MobCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti MobCode.",
  ...
  "help.tabs.introduction": "MobCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse MobCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast MobCode meeskonnale",
  ...
  "sidebar.gettingStarted.line1": "MobCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "MobCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage MobCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke MobCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas MobCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas MobCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas MobCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui MobCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse MobCode uusimat versiooni.",

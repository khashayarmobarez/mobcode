export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MobCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i MobCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i mobcode.json",
  ...
  "dialog.server.description": "Skift hvilken MobCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker MobCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer MobCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater MobCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før MobCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "MobCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter MobCode igen.",
  ...
  "toast.update.description": "En ny version af MobCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MobCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (mobcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MobCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MobCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MobCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MobCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan MobCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om MobCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas MobCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MobCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MobCode.",
  ...
  "desktop.recovery.loadFailed": "MobCode kunne ikke indlæses",
  "desktop.recovery.terminated": "MobCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af MobCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af MobCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "MobCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":

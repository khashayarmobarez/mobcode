...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "MobCode se nije uspio učitati",
  "Prozor aplikacije MobCode neočekivano je zatvoren",
  "MobCode ne reagira",
  ...
  "Instalacija aplikacije MobCode nije uspjela",
  ...
  "MobCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije MobCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi MobCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u MobCode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u mobcode.json",
  ...
  "dialog.server.description": "Promijenite na koji se MobCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera MobCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MobCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte MobCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte MobCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte MobCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što MobCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "MobCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite MobCode.",
  ...
  "help.tabs.introduction": "Radna površina MobCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MobCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku MobCode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (mobcode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, MobCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MobCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "MobCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite MobCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za MobCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako MobCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li MobCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je MobCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se MobCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju MobCode.",

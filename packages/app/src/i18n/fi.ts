export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "MobCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MobCodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja MobCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja MobCodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään mobcode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda MobCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan MobCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan MobCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään MobCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään MobCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä MobCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna MobCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin MobCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "MobCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten MobCode uudelleen.",
  ...
  "toast.update.description": "MobCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä MobCode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (mobcode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että MobCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "MobCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita MobCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda MobCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä MobCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö MobCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta MobCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun MobCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät MobCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "MobCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "MobCode-valikko",
  ...
  "desktop.recovery.loadFailed": "MobCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "MobCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "MobCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "MobCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "MobCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":

export const dict = {
  ...
  "desktop.menu.documentation": "Documentație MobCode",
  ...
  "desktop.menu.ariaLabel": "Meniu MobCode",
  ...
  "desktop.recovery.loadFailed": "MobCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra MobCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "MobCode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea MobCode a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea MobCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de MobCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în MobCode.",
  ...
  "dialog.server.description": "Schimbă serverul MobCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică MobCode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează MobCode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează MobCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează MobCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca MobCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "MobCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune MobCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei MobCode",
  ...
  "sidebar.gettingStarted.line1": "MobCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul MobCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru MobCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul MobCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă MobCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema MobCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea MobCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune MobCode.",

export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da MobCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in MobCode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in mobcode.json",
  ...
  "dialog.server.description": "Cambia il server MobCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo MobCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento MobCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna MobCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa MobCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che MobCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "MobCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di MobCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team MobCode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (mobcode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: MobCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server MobCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per MobCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di MobCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se MobCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di MobCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di MobCode",
  ...
  "settings.updates.toast.latest.title": "MobCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di MobCode.",
  ...
  "desktop.menu.documentation": "Documentazione di MobCode",
  ...
  "desktop.menu.ariaLabel": "Menu MobCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare MobCode",
  "desktop.recovery.terminated": "La finestra di MobCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "MobCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di MobCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di MobCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",

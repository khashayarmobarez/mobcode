export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela MobCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "MobCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi MobCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan MobCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh MobCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di MobCode.",
  ...
  "dialog.server.description": "Ganti server MobCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa MobCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui MobCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui MobCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal MobCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MobCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MobCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru MobCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim MobCode",
  ...
  "sidebar.gettingStarted.line1": "MobCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server MobCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk MobCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan MobCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah MobCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat MobCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru MobCode.",

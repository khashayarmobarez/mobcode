export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do MobCode",
  ...
  "desktop.menu.ariaLabel": "Menu do MobCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o MobCode",
  "desktop.recovery.terminated": "A janela do MobCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O MobCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do MobCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O MobCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do MobCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo MobCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MobCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em mobcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor MobCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o MobCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o MobCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o MobCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o MobCode",
  "wsl.onboarding.opencodeReadyIn": "O MobCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O MobCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o MobCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o MobCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O MobCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o MobCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o MobCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do MobCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MobCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (mobcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MobCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MobCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MobCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o MobCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MobCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MobCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MobCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MobCode.",

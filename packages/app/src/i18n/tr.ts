...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MobCode yüklenemedi",
  "desktop.recovery.terminated": "MobCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "MobCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "MobCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "MobCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MobCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MobCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak MobCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MobCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler mobcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MobCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MobCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde MobCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "MobCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde MobCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki MobCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "MobCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde MobCode hazır.",
  "wsl.onboarding.opencodeReady": "MobCode hazır.",
  "wsl.onboarding.installOpencodeIn": "MobCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "MobCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MobCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "MobCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından MobCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "MobCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MobCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MobCode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (mobcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: MobCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MobCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MobCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "MobCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MobCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "MobCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MobCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MobCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MobCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MobCode'un en son sürümünü kullanıyorsunuz.",

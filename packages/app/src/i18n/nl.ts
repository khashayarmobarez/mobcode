export const dict = {
  ...
  "desktop.menu.documentation": "MobCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "MobCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het MobCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "MobCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van MobCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De MobCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door MobCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in MobCode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in MobCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in MobCode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in mobcode.json",
  ...
  "dialog.server.description": "Wijzig met welke MobCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "MobCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "MobCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MobCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "MobCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk MobCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MobCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "MobCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer MobCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat MobCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "MobCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens MobCode opnieuw.",
  ...
  "help.tabs.introduction": "MobCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van MobCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het MobCode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (mobcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: MobCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "MobCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de MobCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor MobCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe MobCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of MobCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van MobCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer MobCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "MobCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van MobCode.",

export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de MobCode",
  ...
  "desktop.menu.ariaLabel": "Menú de MobCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar MobCode",
  "desktop.recovery.terminated": "La ventana de MobCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "MobCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar MobCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de MobCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MobCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MobCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "MobCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MobCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MobCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en mobcode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de MobCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando MobCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando MobCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando MobCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando MobCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza MobCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar MobCode",
  "wsl.onboarding.opencodeReadyIn": "MobCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala MobCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar MobCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que MobCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MobCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir MobCode.",
  ...
  "help.tabs.introduction": "MobCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de MobCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de MobCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (mobcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: MobCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "MobCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MobCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MobCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve MobCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MobCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MobCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MobCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MobCode.",

...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "MobCode failed to load",
  "desktop.recovery.terminated": "MobCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "MobCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "MobCode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MobCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MobCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",

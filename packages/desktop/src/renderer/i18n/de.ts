export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MobCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",

export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'MobCode. Voleu instal·lar-la i reiniciar l'aplicació?",

export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} MobCode a fost descărcată. Vrei să o instalezi și să repornești?",

export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i MobCode është shkarkuar, dëshironi ta instaloni dhe rinisni?",

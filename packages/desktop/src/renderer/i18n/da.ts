export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MobCode er blevet downloadet. Vil du installere den og genstarte?",

export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace MobCode. Chcete ji nainstalovat a aplikaci znovu spustit?",

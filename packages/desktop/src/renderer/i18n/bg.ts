export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от MobCode е изтеглена. Искате ли да я инсталирате и рестартирате?",

export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av MobCode.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av MobCode er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",

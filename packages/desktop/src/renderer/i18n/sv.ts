export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av MobCode har laddats ned. Vill du installera den och starta om programmet?",

export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} MobCode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",

export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van MobCode is gedownload. Wil je deze installeren en MobCode opnieuw starten?",

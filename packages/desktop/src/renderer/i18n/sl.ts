export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} MobCode je bila prenesena, jo želite namestiti in znova zagnati?",

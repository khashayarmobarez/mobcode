export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di MobCode è stata scaricata. Vuoi installarla e riavviare l'app?",

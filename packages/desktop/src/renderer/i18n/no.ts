export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MobCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MobCode er lastet ned. Vil du installere den og starte på nytt?",
